...
public class ConvertImage {
    ...
    public static byte[] imgToBytes(String imageName) throws IOException {
        BufferedImage bImage = ImageIO.read(new File("./src/temp/" + imageName + ".jpg"));
    ...
    public static void bytesToImg(byte[] data, String imageName) throws IOException {
        ...
        ImageIO.write(bImage2, "jpg", new File("./src/temp/" + imageName + ".jpg"));
    ...
    public static boolean existsImg(String imageName) {
        return new File("./src/temp/" + imageName + ".jpg").exists();
    }
    ...
    public static void saveObject(UserEntity obj) throws IOException {
        ...
        try {
            fout = new FileOutputStream("./src/temp/user.ser");
    ...
    public static UserEntity getObject() throws IOException {
        if (!(new File("./src/temp/user.ser").exists())) return null;

        ObjectInputStream objectinputstream = null;
        try {
            FileInputStream streamIn = new FileInputStream("./src/temp/user.ser");
    ...
    public static boolean deleteObject(){
        File file = new File("./src/temp/user.ser");
        return file.delete();
    }
